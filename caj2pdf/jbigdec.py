...
if (arch[1] == 'WindowsPE'):
    if (arch[0] == '64bit'):
        libjbigdec = cdll.LoadLibrary(str(base_dir / "lib/bin/libjbigdec-w64.dll"))
    else:
        libjbigdec = cdll.LoadLibrary(str(base_dir / "lib/bin/libjbigdec-w32.dll"))
else:
    libjbigdec = cdll.LoadLibrary(str(base_dir / "libjbigdec.so"))
